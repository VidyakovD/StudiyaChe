            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-[var(--text-secondary)] text-sm leading-relaxed">
                ...
                <section>
                  ...
                  <p>Мы не передаём персональные данные третьим лицам, за исключением случаев, перечисленных ниже.</p>

                  <p className="mt-3 font-semibold text-[var(--text-secondary)]">5.1. ООО НКО «ЮMoney» (ЮKassa) — приём оплаты и фискализация</p>
                  <p className="mt-1">При оформлении покупки в платёжный сервис ЮKassa передаются следующие данные:</p>
                  <ul className="list-disc list-inside mt-2 space-y-1 text-[var(--text-muted)]">
                    <li>Адрес электронной почты Пользователя — для направления фискального чека</li>
                    <li>Внутренние идентификаторы Пользователя и приобретаемого курса</li>
                    <li>Наименование и стоимость приобретаемой Услуги</li>
                  </ul>
                  <p className="mt-2">
                    Данные, связанные с банковской картой (номер, срок действия, CVV), вводятся
                    Пользователем непосредственно на стороне ЮKassa и на серверах Платформы не
                    обрабатываются и не хранятся. Обработка платежей осуществляется ЮKassa в
                    соответствии с правилами международных платёжных систем по стандарту PCI DSS.
                  </p>
                  <p className="mt-2">
                    Фискальные чеки направляются ЮKassa в Оператор фискальных данных и на
                    электронную почту Пользователя в соответствии с Федеральным законом № 54-ФЗ.
                  </p>

                  <p className="mt-3 font-semibold text-[var(--text-secondary)]">5.2. Иные случаи</p>
                  <ul className="list-disc list-inside mt-2 space-y-1 text-[var(--text-muted)]">
                    <li>По требованию уполномоченных государственных органов в порядке, установленном законодательством Российской Федерации</li>
                  </ul>
                </section>
